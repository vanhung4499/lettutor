...
import 'package:lettutor/core/extensions/color_extension.dart';
import 'package:lettutor/core/extensions/context_extension.dart';
import 'package:tab_indicator_styler/tab_indicator_styler.dart';

import 'field_tab_bar.dart';
import 'tab_bar_paint.dart';
import 'tab_bar_type.dart';
...
class TabBarItemStyle {
  ...
  TabBarItemStyle({
    this.assetIcon = ImageConstant.homeIcon,
...
class FollowIcon extends StatelessWidget {
  ...
  const FollowIcon({
    super.key,
    this.iconData = Icons.home,
    this.svg = ImageConstant.homeIcon,
    this.isSvg = true,
    this.size = 10,
    required this.color,
  });
