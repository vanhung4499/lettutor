...
import 'package:lettutor/core/widgets/pagination_view/pagination_notifier.dart';
...
class PaginationViewCustom<T> extends StatefulWidget {
  ...
  final double spacer;
  // Skelton style
  final SkeletonFormat skeltonFormat;
  //Grid view style
  ...
  const PaginationViewCustom({
    ...
    this.skeltonFormat = const SkeletonFormat(),
...
class _PaginationViewCustomState<T> extends State<PaginationViewCustom<T>> {
  ...
  Widget _loadingBottom() {
    if (widget.typeIndicatorLoading == TypeIndicatorLoading.circularIndicator) {
      ...
      SkeletonFormat format = widget.skeltonFormat;
