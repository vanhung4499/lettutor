...
import '../../data/models/request/search_tutor_request.dart' as _i43;
...
import '../../domain/usecases/become_tutor_usecase.dart' as _i45;
import '../../domain/usecases/booking_usecase.dart' as _i20;
import '../../domain/usecases/course_detail_usecase.dart' as _i46;
import '../../domain/usecases/course_usecase.dart' as _i27;
import '../../domain/usecases/ebook_usecase.dart' as _i28;
import '../../domain/usecases/feedback_tutor_usecase.dart' as _i37;
import '../../domain/usecases/login_usecase.dart' as _i29;
import '../../domain/usecases/main_usecase.dart' as _i30;
...
import '../../domain/usecases/tutor_schedule_usecase.dart' as _i40;
import '../../domain/usecases/user_profile_usecase.dart' as _i44;
import '../../presentation/auth/blocs/login/login_bloc.dart' as _i50;
...
import '../../presentation/tutor_detail/blocs/tutor_report_bloc.dart' as _i39;
...
import '../../presentation/tutor_search/blocs/tutor_search_bloc.dart' as _i41;
...
_i1.GetIt init(
  ...
  gh.factory<_i29.LoginUseCase>(
      () => _i29.LoginUseCase(gh<_i18.AuthRepository>()));
  gh.factory<_i30.MainUseCase>(() => _i30.MainUseCase(
        gh<_i12.TutorRepository>(),
        gh<_i25.CourseRepository>(),
        gh<_i22.CommonRepository>(),
      ));
  gh.factory<_i31.RegisterBloc>(
      () => _i31.RegisterBloc(login: gh<_i29.LoginUseCase>()));
  gh.factory<_i32.ResetPasswordUseCase>(
      () => _i32.ResetPasswordUseCase(gh<_i18.AuthRepository>()));
  gh.factory<_i33.ScheduleBloc>(
      () => _i33.ScheduleBloc(bookingUseCase: gh<_i20.BookingUseCase>()));
  gh.factory<_i34.SearchTutorUseCase>(() => _i34.SearchTutorUseCase(
        gh<_i22.CommonRepository>(),
        gh<_i12.TutorRepository>(),
      ));
  gh.factory<_i35.SettingUseCase>(
      () => _i35.SettingUseCase(gh<_i15.UserRepository>()));
  gh.factory<_i36.TutorDetailUseCase>(() => _i36.TutorDetailUseCase(
        gh<_i12.TutorRepository>(),
        gh<_i15.UserRepository>(),
      ));
  gh.factory<_i37.TutorFeedbackUseCase>(
      () => _i37.TutorFeedbackUseCase(gh<_i15.UserRepository>()));
  gh.factory<_i38.TutorListUseCase>(() => _i38.TutorListUseCase(
        gh<_i12.TutorRepository>(),
        gh<_i15.UserRepository>(),
        gh<_i7.ScheduleRepository>(),
      ));
  gh.factoryParam<_i39.TutorReportBloc, String, dynamic>((
    userId,
    _,
  ) =>
      _i39.TutorReportBloc(
        userId,
        tutorDetailUseCase: gh<_i36.TutorDetailUseCase>(),
      ));
  gh.factory<_i40.TutorScheduleUseCase>(() => _i40.TutorScheduleUseCase(
        gh<_i12.TutorRepository>(),
        gh<_i15.UserRepository>(),
      ));
  gh.factory<_i41.TutorSearchBloc>(() =>
      _i41.TutorSearchBloc(searchTutorUseCase: gh<_i34.SearchTutorUseCase>()));
  gh.factoryParam<_i42.TutorSearchResultBloc, _i43.SearchTutorRequest, dynamic>(
      (
    request,
    _,
  ) =>
          _i42.TutorSearchResultBloc(
            request,
            searchTutorUseCase: gh<_i34.SearchTutorUseCase>(),
          ));
  gh.factory<_i44.UserProfileUseCase>(() => _i44.UserProfileUseCase(
        gh<_i15.UserRepository>(),
        gh<_i22.CommonRepository>(),
      ));
  gh.factory<_i45.BecomeTutorUseCase>(() => _i45.BecomeTutorUseCase(
        gh<_i15.UserRepository>(),
        gh<_i22.CommonRepository>(),
      ));
  gh.factory<_i46.CourseDetailUseCase>(
      () => _i46.CourseDetailUseCase(gh<_i25.CourseRepository>()));
  gh.factory<_i47.CourseListBloc>(
      () => _i47.CourseListBloc(courseUseCase: gh<_i27.CourseUseCase>()));
  gh.factory<_i48.EbookBloc>(
      () => _i48.EbookBloc(ebookUseCase: gh<_i28.EbookUseCase>()));
  gh.factory<_i49.HomeBloc>(
      () => _i49.HomeBloc(mainUseCase: gh<_i30.MainUseCase>()));
  gh.factory<_i50.LoginBloc>(
      () => _i50.LoginBloc(login: gh<_i29.LoginUseCase>()));
  ...
  gh.factory<_i52.SettingBloc>(
      () => _i52.SettingBloc(gh<_i35.SettingUseCase>()));
  ...
  gh.factoryParam<_i54.TutorFeedbackBloc, String, dynamic>((
    ...
    _,
      ...
      _i54.TutorFeedbackBloc(
        booId,
        tutorFeedbackUseCase: gh<_i37.TutorFeedbackUseCase>(),
      ));
  gh.factory<_i55.TutorListBloc>(
      () => _i55.TutorListBloc(tutorListUseCase: gh<_i38.TutorListUseCase>()));
  gh.factory<_i56.UserProfileBloc>(() => _i56.UserProfileBloc(
        userProfileUseCase: gh<_i44.UserProfileUseCase>(),
