...
import 'package:lettutor/domain/entities/course/course_topic.dart';
...
import '../blocs/course_detail_bloc.dart';
import '../blocs/course_detail_state.dart';
...
class _CourseDetailScreenState extends State<CourseDetailScreen> {
  ...
  Iterable<Column> _overViewField(Course course) {
    return [
      ...
      final renderHeader =
      index == 0 ? S.of(context).whyTTCourse : S.of(context).whatWYBe;
      return Column(
      ...
      onTap: () {
        if (courseTopicModel.nameFile?.isNotEmpty ?? false) {
          context.openPageWithRouteAndParams(
              Routes.pdfViewer, courseTopicModel.nameFile);
        }
      },
      child: Container(
