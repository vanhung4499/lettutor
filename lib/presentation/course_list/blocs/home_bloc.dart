...
@injectable
class CourseListBloc extends DisposeCallbackBaseBloc {
  ///[functions] input
  ...
  final Stream<CourseListState> state$;
  ...
  factory CourseListBloc({required CourseUseCase courseUseCase}) {
    ///[controllers]
    ...
    final state$ = Rx.merge<CourseListState>([
      ...
      fetchData$
        ...
        try {
          ...
          return Stream<CourseListState>.error(
