...
import 'package:lettutor/domain/usecases/tutor_schedule_usecase.dart';
...
import 'tutor_schedule_state.dart';

@injectable
class TutorScheduleBloc extends DisposeCallbackBaseBloc {
  ///[Functions]
  final Function0<void> getTutorSchedule;

  final Function2<DateTime, DateTime, void> selectTime;

  final Function2<String, String, void> bookTutorClass;

  ///[Streams]

  final Stream<bool?> loading$;

  final Stream<bool?> loadingTutorClass$;
  ...
  TutorScheduleBloc._({
    ...
    required this.loadingTutorClass$,
    required this.getTutorSchedule,
    required this.bookTutorClass,
  ...
  factory TutorScheduleBloc(@factoryParam String userId,
    ...
    final booTutorClassState$ = Rx.merge<TutorScheduleState>([
      booTutorClass$
        ...
        try {
          return tutorScheduleUseCase
              .bookingTutorClass(scheduleDetailIds: [scheduleId], note: note)
              .doOn(
