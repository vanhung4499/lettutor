...
class _ScheduleApi implements ScheduleApi {
  ...
  Future<HttpResponse<BookingResponse?>> getBookingHistory(
    ...
    final value =
        _result.data == null ? null : BookingResponse.fromJson(_result.data!);
  ...
  Future<HttpResponse<UpcomingResponse?>> getUpComingClass(int time) async {
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>?>(
        _setStreamType<HttpResponse<UpcomingResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value =
        _result.data == null ? null : UpcomingResponse.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
