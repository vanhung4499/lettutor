...
class _CourseApi implements CourseApi {
  ...
  Future<HttpResponse<ListCourseResponse?>> listCourses(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(
        _setStreamType<HttpResponse<ListCourseResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = _result.data == null
        ? null
        : ListCourseResponse.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }

  @override
  Future<HttpResponse<CourseDetailResponse?>> getCourse(String courseId) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
