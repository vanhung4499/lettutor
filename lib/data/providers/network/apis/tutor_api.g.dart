...
class _TutorApi implements TutorApi {
  ...
  Future<HttpResponse<ListTutorResponse?>> pagFetchData(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>?>(
        _setStreamType<HttpResponse<ListTutorResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value =
        _result.data == null ? null : ListTutorResponse.fromJson(_result.data!);
  ...
  Future<HttpResponse<SearchTutorResponse?>> searchTutor(
    ...
    final value = _result.data == null
        ? null
        : SearchTutorResponse.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }
  ...
  Future<HttpResponse<ListScheduleResponse?>> getTutorSchedule(
    ...
    final Map<String, dynamic>? _data = null;
    final _result = await _dio.fetch<Map<String, dynamic>?>(
        _setStreamType<HttpResponse<ListScheduleResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = _result.data == null
        ? null
        : ListScheduleResponse.fromJson(_result.data!);
    final httpResponse = HttpResponse(value, _result);
    return httpResponse;
  }

  @override
  Future<HttpResponse<ListReviewResponse>> listReview(
    String id, {
    ...
    _data.addAll(body);
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<HttpResponse<ListReviewResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
